      ...
      >
        ...
        {daysInMonth.map((date) => (
          <div
            ...
            onMouseEnter={() => isNationalHoliday(date) ? showTooltip(nationalHolidays.find(d => d.date === format(date, "yyyy-MM-dd"))) : null}
        ...
        <div className="font-semibold text-right pr-2 mt-6">
          Σ
        </div>
        ...
        {projects.map((project, rowIndex) => (
          <>
            ...
            <div
              key={project.id}
              className={cn("sticky left-0 bg-cyan-950 z-10 flex items-center font-medium rounded-sm ps-2",
        ...
        {/* ===== Column sums ===== */}
        <div className="sticky left-0 z-10 font-semibold mt-2">
          Σ
        </div>
